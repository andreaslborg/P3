using LoginPage4.Areas.Identity;
using LoginPage4.Authorization;
using LoginPage4.Data;
...
namespace LoginPage4
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //options.UseSqlite( "DataSource=app.dv" ));
            services.AddDbContext<AppDbContext>(options =>
            ...
            services.AddAuthorization(options => 
            {
                ...
                options.AddPolicy("IsEditor", policy =>
                    policy.AddRequirements(new EmailRequirement("editor.com")));
            });
